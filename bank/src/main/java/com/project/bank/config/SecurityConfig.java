...
import com.project.bank.security.CustomUserDetailsService;

import com.project.bank.security.handler.Custom403Handler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        ...
        http.formLogin()
                ...
                .defaultSuccessUrl("/main")             // 로그인 성공시 이동할 페이지경로
                .usernameParameter("memberId")         // 로그인시 사용할 이름
